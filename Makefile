...
docker-build:
	...
	docker build -t  213026892552.dkr.ecr.us-east-1.amazonaws.com/analytics-service:$(image_tag) .
	docker push 213026892552.dkr.ecr.us-east-1.amazonaws.com/analytics-service:$(image_tag)
